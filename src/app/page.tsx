  ...
  return (
    ...
    >
      ...
      {loading ? (
        ...
        horoscope && (
          <div
            className=" w-full max-w-[550px] rounded-[30px] sm:dark:bg-gray-800 sm:dark:text-white flex flex-col hover:shadow-lg min-h-[280px] dark:bg-gray-800 dark:text-white items-start relative group mt-6 p-4 sm:p-6 lg:p-10"
          >
            <div className="m-3">
